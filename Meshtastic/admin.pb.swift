...
struct AdminMessage {
  ...
  var getCannedMessagePluginPart1Response: String {
    get {
  ...
  var getCannedMessagePluginPart2Response: String {
    get {
  ...
  var getCannedMessagePluginPart3Response: String {
    get {
  ...
  var getCannedMessagePluginPart4Response: String {
    get {
  ...
  var setCannedMessagePluginPart1: String {
    get {
  ...
  var setCannedMessagePluginPart2: String {
    get {
  ...
  var setCannedMessagePluginPart3: String {
    get {
  ...
  var setCannedMessagePluginPart4: String {
    get {
  ...
  enum OneOf_Variant: Equatable {
    ...
    case getCannedMessagePluginPart1Response(String)
    ///
    /// Get the Canned Message Plugin message part2 in the response to this message.
    case getCannedMessagePluginPart2Request(Bool)
    case getCannedMessagePluginPart2Response(String)
    ///
    /// Get the Canned Message Plugin message part3 in the response to this message.
    case getCannedMessagePluginPart3Request(Bool)
    case getCannedMessagePluginPart3Response(String)
    ///
    /// Get the Canned Message Plugin message part4 in the response to this message.
    case getCannedMessagePluginPart4Request(Bool)
    case getCannedMessagePluginPart4Response(String)
    ///
    /// Set the canned message plugin part 1 text.
    case setCannedMessagePluginPart1(String)
    ///
    /// Set the canned message plugin part 2 text.
    case setCannedMessagePluginPart2(String)
    ///
    /// Set the canned message plugin part 3 text.
    case setCannedMessagePluginPart3(String)
    ///
    /// Set the canned message plugin part 4 text.
    case setCannedMessagePluginPart4(String)
    ///
    /// Tell the node to shutdown in this many seconds (or <0 to cancel shutdown)
...
extension AdminMessage: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    44: .standard(proto: "set_canned_message_plugin_part1"),
    45: .standard(proto: "set_canned_message_plugin_part2"),
    46: .standard(proto: "set_canned_message_plugin_part3"),
    47: .standard(proto: "set_canned_message_plugin_part4"),
